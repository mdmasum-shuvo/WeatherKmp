...
import com.example.weatherkmp.ui.viewmodel.HomeViewModel
...
fun HomeScreen(
    ...
    val homeViewModel: HomeViewModel = koinInject<HomeViewModel>()
    ...
    Box(
        ...
        Column(
            ...
            Column(
                ...
                homeViewModel.weatherData.collectAsState().value?.let {
                    WeatherData(it)
                }
